...
module.exports = {//注意这里是exports不是export
    devtool:"eval-source-map",//生成Source Maps,这里使用eval-source-map.其他的还有source-map,cheap-module-source-map,cheap-module-eval-source-map
    ...
    module: {
        ...
        rules: [
            ...
            {
                test: /\.css$/,//一个匹配loaders所处理的文件的拓展名的正则表达式，这里用来匹配css文件（必须）
                exclude: /node_modules/,//屏蔽不需要处理的文件（文件夹）（可选）
                use: 'css-loader',//loader的名称（必须）
            },
